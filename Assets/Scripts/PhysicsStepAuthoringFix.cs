...
{
    // This is literally a copy paste of physics step authoring, but I had to change its name because it didn't appear in the component menu
    [AddComponentMenu("Entities/Physics/Physics Step")]
    [DisallowMultipleComponent]
    public sealed class PhysicsStepAuthoringFix : MonoBehaviour
    {
    ...
    internal class PhysicsStepBaker : Baker<PhysicsStepAuthoringFix>
    {
        public override void Bake(PhysicsStepAuthoringFix authoring)
        {
